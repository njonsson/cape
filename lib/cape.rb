...
module Cape
  ...
  autoload :CapistranoDeprecated,       'cape/capistrano_deprecated'
  autoload :CoreExt,                    'cape/core_ext'
  autoload :Deprecation,                'cape/deprecation'
  autoload :DSL,                        'cape/dsl'
  autoload :DSLDeprecated,              'cape/dsl_deprecated'
  autoload :HashList,                   'cape/hash_list'
  autoload :Rake,                       'cape/rake'
  autoload :RecipeDefinition,           'cape/recipe_definition'
  autoload :RecipeDefinitionDeprecated, 'cape/recipe_definition_deprecated'
